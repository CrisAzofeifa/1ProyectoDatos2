...
QT_MOC_LITERAL(19, 238, 20), // "dividirEnExpresiones"
QT_MOC_LITERAL(20, 259, 5) // "Texto"
    ...
    "nombre\0dividirEnExpresiones\0Texto"
};
...
static const uint qt_meta_data_IDE_CFactorial[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, 0x80000000 | 7, 0x80000000 | 7, 0x80000000 | 7,   17,   18,   12,
...
void IDE_CFactorial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: { bool _r = _t->validarExpresion((*reinterpret_cast< Expresion(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 8: _t->generarJson((*reinterpret_cast< string(*)>(_a[1])),(*reinterpret_cast< string(*)>(_a[2])),(*reinterpret_cast< string(*)>(_a[3]))); break;
